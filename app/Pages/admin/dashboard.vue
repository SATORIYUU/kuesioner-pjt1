<template>
  <div class="h-screen w-full bg-[#F4F7FA] flex overflow-hidden font-sans text-slate-800">
    ...
    <!-- CONTENT AREA -->
    <div class="flex-1 flex flex-col min-w-0 bg-[#F8FAFC] overflow-hidden relative">
...
// TOGGLE NOTIFIKASI (SIMPAN STATUS DIBACA KE LOCALSTORAGE)
...
// LOGIKA NOTIFIKASI LONCENG SUPABASE (DENGAN PEMERIKSAAN LOCALSTORAGE)
...
onMounted(() => {
  ...
  realtimeChannel = supabase
    .channel('public:questionnaire_responses')
