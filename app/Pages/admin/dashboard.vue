<template>
  <div class="h-screen w-full bg-[#F4F7FA] flex overflow-hidden font-sans text-slate-800">
    ...
    <main class="flex-1 flex flex-col min-w-0 bg-[#F8FAFC] overflow-hidden">
      ...
      <header class="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-8 shrink-0 w-full">
                ...
                <tbody class="divide-y divide-slate-100 font-medium">
                  ...
                  <tr v-else v-for="(row, index) in tableData" :key="index" class="hover:bg-slate-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-center">
                      <button @click="viewDetail(row.id)" class="text-[#004B87] hover:text-sky-600 p-2 rounded-lg hover:bg-blue-50 transition-colors">
